                ...
                <Modal.Body>
                    <form style={{ margin: '10px', padding: '5px' }}>
                        <div className="mb-3"> <label htmlFor="id">ID:</label>
                            <input type="text" placeholder="enter id" name="id" value={inputdetais.id} onChange={handlechange} />
                            <br />
                        </div>
                        <div className="mb-3 mt-3"> <label htmlFor="id">Users:</label>

                            <input type="text" placeholder="enter user" name="username" value={inputdetais.username} onChange={handlechange} /><br />
                        </div>
                        <div className="mb-3"> <label htmlFor="id">EMAIL</label>
